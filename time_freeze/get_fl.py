...
usage- python get_fl.py -p TWMET -i TWDIS_11098 -n 50 -o out_file
'''
# import libraries
import os
...
class GetFirstLayer():
    ...
    def get_relations(self):
        ...
        self.mydict['concept_ids_subject'] = self.concept_id
        results = self.session.post(f"{self.base_url}conceptset/relations/", self.mydict)
        ...
        self.mydict['concept_ids'] = ",".join(my_id_list)
        # self.payload
        return  relations
    ...
    def json_todf(self):
        ...
        return data[(data['score'] >= 5) & (data['overlap'] >= 2)]
        #return data
